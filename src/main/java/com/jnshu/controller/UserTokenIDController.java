...
public class UserTokenIDController {
    ...
    public void userTokenId(HttpServletRequest request, Model model) throws IllegalBlockSizeException, InvalidKeyException, BadPaddingException, NoSuchAlgorithmException, NoSuchPaddingException {
        /*获取请求里的cookie中的token*/
